...
- :+1: &nbsp; Huster et al., **Limitations of the Lipschitz Constant as a Defense Against Adversarial Examples**, 2018.
  ...
  - The bound is, however, coupled with distance $c$ of the dataset. This assumption must be required for any K-Lipschitz bound that tries to achieve 100% accuracy. #thoughts what's an effective way to balance clean accuracy and robustness with Lipschitz?
...
- Kariyappa and Qureshi, **Improving Adversarial Robustness of Ensembles with Diversity Training**, 2019. #ensemble
